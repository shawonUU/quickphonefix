          ...
          <div id="preview" style="padding: 2px;" content="width=device-width, initial-scale=1.0">
            <div class="row">
              <div class="col-12 text-center">
                ...
                <p></p>
                <p class="mb-0 xsm-text fk-print-text text-center text-capitalize" style="font-size: 14px;">Gulshan-2</p>
                <p class="mb-0 xsm-text fk-print-text text-center text-capitalize" style="font-size: 14px;">Hotline: +880 1300-295555</p>
