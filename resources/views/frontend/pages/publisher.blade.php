...
<div id="main-module-container">
   <div class="breadcrumb-title-wrapper">
      <div class="breadcrumb-title">
         <h1 class="heading-title page-title">প্রকাশক</h1>
      </div>
   </div>
               ...
               <div class="">
                  <div class="content" role="main">
                           ...
                           <div class="cls_search" style="width:400px;">
                              <form action="" class="form-inline" method="get">
                                 <div class="search-box">
                                    <input type="text" id="cat_search" placeholder="প্রকাশক অনুসন্ধান করুন" value="" name="q" class="form-control ui-autocomplete-input" autocomplete="off" style="float: left;color:#666666">
                     ...
                     <ul class="archive-product-subcategories" style="float:left;width:100%">
                        @foreach ($lib_publisher as $key => $value)
                            <li class="author-list product-category product col-sm-6 first">
                                <a href="{{route('filterProduct',['type' => 'book', 'publisher' => $key])}}" class="author_name">
                                <h3> {{ $value }} </h3>
                                </a>
                            </li>
                        @endforeach
