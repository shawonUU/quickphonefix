                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar="init" style="max-height: 320px;"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                            ...
                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="{{ route('dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">how to setup <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="{{ route('dashboard') }}" class="btn btn-soft-secondary btn-sm rounded-pill">buttons <i class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="https://media.istockphoto.com/id/1300845620/vector/user-icon-flat-isolated-on-white-background-user-symbol-vector-illustration.jpg?s=612x612&w=0&k=20&c=yBeyba0hUkh14_jgv1OKqIH0CCSWU_4ckRkAoy2p73o=" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ auth()->user()->name }}</span>
                                @php
                                    $userRole = auth()->user()->getRoleNames()->first(); // Gets the first role if there are multiple
                                @endphp
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header text-dark">Welcome {{ auth()->user()->name }}!</h6>
...
<audio id="myAudio" class="d-none" controls >
...
<script>
    ...
    appChannel.bind('place-order-notification', function(data) {
        // alert('sxasa');
        // console.log(data);
        ...
        var html = `<div class="text-reset notification-item d-block dropdown-item position-relative" >
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="javascript:void(0)" onclick="updateNotification(${data.notification.id}, ${data.notification.url})" class="stretched-link">
        ...
        var eles = document.getElementsByClassName('unSeenNotifications');
        for(var i=0; i<eles.length; i++){
            // console.log( eles[i])
            eles[i].innerHTML = data.unSeenNotifications;
        }
        var element = document.getElementById('unSeenNotifications').classList.remove('d-none');
    ...
    function updateNotification(id, url){
        ...
        $.post('{{ route('update-notification') }}', {id:id, _token:token}, function(data){
