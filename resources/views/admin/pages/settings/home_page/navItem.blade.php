...
<style>
    ...
    <script>
        ...
        function updateOrder(){
            ...
            $.post('{{route('settings.update_nav_item_priyority')}}', {ids:JSON.stringify(ids), _token:'{{csrf_token()}}'}, function(data){
        ...
        function updateTitle(id, value){
            $.post('{{route('settings.update_nav_item_titel')}}', {id:id,title:value, _token:'{{csrf_token()}}'}, function(data){
                flashMessage(data.type,data.message);
            });
        }
