            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-row-reverse bd-highlight">
                        <button type="button" class="btn btn-sm btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#myModal">Add Publisher</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Add Publisher</h5>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Publisher List</h4>
                        </div>
                            ...
                            <table class="table table-stripedw-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:80px; border:none;"><img style="height: 50px; width:100%;" src="{{asset('frontend/publisher_images/'.$item->image)}}" alt=""></td>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('publisher.update', $item->id) }}" method="POST"  enctype="multipart/form-data">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <img style="height:100px; width:100px;" src="{{asset('frontend/publisher_images/'.$item->image)}}" alt="">
                                                                </div>
                                                                <div class="d-block">
...
<script>
    function showOnHome(id,ele){
        ...
        $.post('{{route('publisher.showOnHome')}}', {id:id,homeView:homeView,_token:'{{csrf_token()}}'}, function(data){
