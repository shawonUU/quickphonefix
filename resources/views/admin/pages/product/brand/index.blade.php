            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-row-reverse bd-highlight">
                        <button type="button" class="btn btn-sm btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#myModal">Add Brand</button>
                            ...
                            <table class="table table-stripedw-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="height: 100px; width:100;" src="{{asset('frontend/brand_images/'.$item->image)}}" alt=""></td>
                                        <td>{{$item->name}}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('brand.update', $item->id) }}" method="POST"  enctype="multipart/form-data">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <img style="height:100px; width:100px;" src="{{asset('frontend/brand_images/'.$item->image)}}" alt="">
                                                                </div>
                                                                <div class="d-block">
...
<script>
        function showOnHome(id,ele){
            ...
            $.post('{{route('brand.showOnHome')}}', {id:id,homeView:homeView,_token:'{{csrf_token()}}'}, function(data){
