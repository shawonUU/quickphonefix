...
@section('content')
    ...
    <script>
        function showOnHome(id,ele){
            ...
            $.post('{{route('categories.showOnHome')}}', {id:id,homeView:homeView,_token:'{{csrf_token()}}'}, function(data){
        ...
        function showOnNav(id,ele){
            ...
            $.post('{{route('categories.showOnNav')}}', {id:id,navView:navView,_token:'{{csrf_token()}}'}, function(data){
                flashMessage(data.type,data.message);
            });
        }
    </script>
