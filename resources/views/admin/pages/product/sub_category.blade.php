                                        ...
                                        <div class="modal-body">
                                            <div>
                                                ...
                                                <select class="form-control" name="category" require>
                                                    ...
                                                    @foreach(lib_category() as $key => $category)
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div id="myModal{{ $subCategory->id }}" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('sub-categories.destroy',$subCategory->slug) }}" method="post">
                                                                @csrf
                                                                @method('delete')
                                            ...
                                            <form action="{{ route('sub-categories.update', $subCategory->slug) }}" method="POST" enctype="multipart/form-data">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
