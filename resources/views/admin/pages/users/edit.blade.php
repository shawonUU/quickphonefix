                            ...
                            <form action="{{ route('users.update',$user->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-3 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('phone',$user->phone) }}" id="phone" name="phone" placeholder="Enter User phone" >
                                    </div>                               
                                    <div class="col-xxl-3 col-md-6 mb-3">
                                    ...
                                    <div class="col-xxl-3 col-md-6 mb-3">
                                        ...
                                        <select class="form-select mb-3" name="status">
                                            <option {{ $user->status == '1' ?'selected':'' }} value="1">Actve</option>
                                            <option {{ $user->status == '0' ?'selected':'' }} value="0">InActve</option>
                                        </select>
                                    </div>
                                    <div class="col-xxl-3 col-md-6 mb-3">
